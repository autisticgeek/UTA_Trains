...
const apiUrl = `https://vschool-cors.herokuapp.com/?url=http://api.rideuta.com/SIRI/SIRI.svc/VehicleMonitor/ByRoute?route=704&onwardcalls=true&usertoken=USEKQBT0XC3`;
    return dispatch => {
        axios.get(apiUrl)
            .then(response => {
                dispatch({
